...
public class GCMNotificationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (!extras.isEmpty()) {  // has effect of unparcelling Bundle
            ...
            if (GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR.equals(messageType)) {
                ...
                boolean notificationtrue = prefs.getBoolean("pushnotifications_new_message", true);
                if(notificationtrue) {
    ...
    private void sendNotification(String msg) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, Frontpage.class), 0);

        NotificationCompat.Builder mBuilder =
                new NotificationCompat.Builder(this)
                        .setSmallIcon(R.mipmap.ic_launcher)
                        .setContentTitle("LeibnizVP")
                        .setStyle(new NotificationCompat.BigTextStyle()
                                .bigText(msg))
                        .setContentText(msg);
        SharedPreferences pref= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String text = pref.getString("pushnotifications_new_message_ringtone","");
        ...
        boolean vibrate = pref2.getBoolean("pushnotifications_new_message_vibrate", false);
        if(vibrate){
